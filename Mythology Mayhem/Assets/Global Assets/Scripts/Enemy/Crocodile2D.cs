...
public class Crocodile2D : MonoBehaviour
{
    Enemy enemy;
    ...
    [SerializeField] float jumpDistance = 6f;
    [SerializeField] string snapTrigger = "Snap";
    ...
    {
        Attack(jumpTrigger, jumpDistance);
    }//end jump attack
    ...
    public void SnapAttack()
    {
        Attack(snapTrigger, snapDistance);
    }//end snap attack
